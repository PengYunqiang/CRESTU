function result = solve_radiation_freq(domain, omega, rho, gravity)
% SOLVE_RADIATION_FREQ Solve all rigid-body radiation modes at one angular frequency.
%
% Syntax:
%   result = solve_radiation_freq(domain, omega, rho, gravity)
%
% Description:
...
%   gravity                  - [scalar] Gravitational acceleration, [m/s^2].
%
% Outputs:
