...
%   audit  - Component counts, SHA-256 hashes, and merged-geometry hash.
    ...
    outerTruncation = struct('enabled', false, 'geometryModified', false);
    if isfield(domain, 'cfg') && isfield(domain.cfg, 'outer_truncation') && ...
            isfield(domain.cfg.outer_truncation, 'effective')
        outerTruncation = domain.cfg.outer_truncation.effective;
    end
    ...
    audit = struct('body', bodyFingerprint, ...
        ...
        'outerTruncation', outerTruncation);
end
