...
% GENERATE_FREE_SURFACE_BMF Execute the documented generate_free_surface_bmf operation.
%
% Syntax:
...
%
% Outputs:
%   mesh_fs         : [documented value] Function result; dimensions and units follow the implemented contract.
%
