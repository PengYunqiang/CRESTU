...
%% Stage 2: Reconstruct smooth surface kinematics
...
%% Stage 3: Construct the exact outward waterline contour normal
...
%% Stage 4: Interpolate the potential continuously to waterline nodes
...
%% Stage 5: Evaluate the four time-averaged contributions
